         ...
         <div class="col-12">
             <div class="card mb-4">
                 <div class="card-header pb-0">
                     ...
                     <a href="../ADMINISTRADOR/registrar_pruebas.php" class="btn btn-primary btn-sm">Añadir</a>
                     <h6>Authors table</h6>
                             ...
                             <tbody>
                                 <?php while ($row_pacientes = $pacientes->fetch_assoc()) {  ?>
                                     ...
                                     <tr>
                                         ...
                                         <td> <span class="text-bold text-danger"><?= $row_pacientes['precio']; ?></span> </td>
                        
                                         <td>

                                             <a href="../ADMINISTRADOR/editar_prueba.php?id=<?= $row_pacientes['id'];  ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
