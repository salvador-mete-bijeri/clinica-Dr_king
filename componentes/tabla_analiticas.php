         ...
         <div class="col-12">
             <div class="card mb-4">
                 <div class="card-header pb-0">
                     ...
                     <a href="../ADMINISTRADOR/registrar_analiticas.php" class="btn btn-primary btn-sm">Añadir</a>
                     <h6>Authors table</h6>
                                 ...
                                 <?php while ($row_pacientes = $pacientes->fetch_assoc()) {  ?>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             ...
                                             <a href="../ADMINISTRADOR/editar_analiticas.php?id=<?= $row_pacientes['id'];  ?>" class="btn btn-sm btn-primary">Editar</a>
