...
$sql_editar = "SELECT * FROM tipo_prueba WHERE id=$id LIMIT 1";
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        <p class="mb-0 p-2">Informacion de la prueba</p>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <form action="../php/actualizar_analiticas.php" id="miFormulario" method="post" enctype="multipart/form-data">


                            <div class="d-flex flex-row justify-content-center">
                                <div class="p-2 col-lg-5">
                                    <input type="hidden" name="id" id="id" value="<?php  echo $fila_editar['id'];   ?>">
                                    <label for="nombre" class="form-label">NOMBRE</label>
                                    <input type="txt" class="form-control" name="nombre" id="nombre" value="<?php  echo $fila_editar['nombre_prueba'];   ?>" placeholder="introduce el nombre"  required>
                                </div>

                                <div class="p-2 col-lg-5">
                                    <label for="precio" class="form-label">PRECIO</label>
                                    <input type="number" class="form-control" name="precio" id="precio" value="<?php  echo $fila_editar['precio'];   ?>" placeholder="introduce el precio"  required>
                                </div>
