                ...
                <ul class="list-group">
                  <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                    <div class="d-flex align-items-center">
                      ...
                      $pagado = $row_prueba2['pagado'];

                      if ($pagado == 0) {

                        $pagado = "<span class='badge bg-danger'>NO PAGADA...</span>";
                      } else {
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <span class="text-xs"><?= $fila3['nombre_prueba']; ?>,  <span class="font-weight-bold"><?= $pagado; ?></span>, <span class="font-weight-bold"><?= $row_prueba2['fecha']; ?></span></span>
                      </div>
                    </div>
                    <div class="d-flex">
